...
datadict_name, time_period, data_set_abbrev, data_set, etl_stage, dict_file_name, dict_file_location, dict_file_type, data_file_name, data_file_location, data_file_type, 
datadict_types, comments, date_created, creator, last_updated, update_user, 
exclude, delete_row, rowsource, hubid, orgid, projid
) 
VALUES (
'CPS high school grade files, 2013', '2013', 'CPS_GRADES_HS_SEM', 0, 'ready', 'hsgradefiles_documentation2.xlsx', '', 'xlsx', '', '', 'fixed width',
